...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>Notice/frontlist">站内通知信息</a></li>
  		<li class="active">详情查看</li>
	</ul>
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">通知id:</div>
	...
	<div class="row bottom15"> 
		...
		<div class="col-md-10 col-xs-6"><%=notice.getAddTime()%></div>
	</div>
	<div class="row bottom15">
