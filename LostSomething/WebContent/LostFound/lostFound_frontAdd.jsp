			...
			<div>
				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="lostFoundAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="lostFound_goodsPhoto" class="col-md-2 text-right">物品照片:</label>
						  	 <div class="col-md-8">
						...
						<!--   <div class="form-group">
						  ...
						  <div class="form-group">
						  	 <label for="lostFound_addTimeDiv" class="col-md-2 text-right">发布时间:</label>
						  	 <div class="col-md-8">
				                <div id="lostFound_addTimeDiv" class="input-group date lostFound_addTime col-md-12" data-link-field="lostFound_addTime">
				                    <input class="form-control" id="lostFound_addTime" name="lostFound.addTime" size="16" type="text" value="" placeholder="请选择捡得时间" readonly>
				                    <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
				                    <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
				                </div>
						  	 </div>
...
$(function(){
	...
	//捡得时间组件
	$('#lostFound_addTimeDiv').datetimepicker({
		language:  'zh-CN',  //显示语言
		format: 'yyyy-mm-dd hh:ii:ss',
		weekStart: 1,
		todayBtn:  1,
		...
		//下面这行代码解决日期组件改变日期后不验证的问题
		$('#lostFoundAddForm').data('bootstrapValidator').updateStatus('lostFound.addTime', 'NOT_VALIDATED',null).validateField('lostFound.addTime');
	});
})
</script>
</body>
