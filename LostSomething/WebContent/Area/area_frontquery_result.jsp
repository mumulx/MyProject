		...
		<div class="col-md-12 wow fadeInDown" data-wow-duration="0.5s">
			<div>
				...
				<ul class="nav nav-tabs" role="tablist">
			    	...
			    	<li role="presentation" ><a href="<%=basePath %>Area/area_frontAdd.jsp" >添加学院</a></li>
				</ul>
			  	<!-- Tab panes -->
			    					...
			    					<% 
										...
										<tr>
											...
											<td>
												...
												<a href="#" onclick="areaEdit('<%=area.getAreaId() %>');" ><i class="fa fa-pencil fa-fw"></i>编辑</a>&nbsp;
												<a href="#" onclick="areaDelete('<%=area.getAreaId() %>');"><i class="fa fa-trash-o fa-fw"></i>删除</a>
											</td> 
										</tr>
										<%}%>
			    				</table>
