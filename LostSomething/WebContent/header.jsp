			...
			<div class="modal-body">
				<form class="form-horizontal" name="registerForm" id="registerForm"
					...
					<div class="form-group">
						<label for="password" class="col-md-3 text-right">登录密码:</label>
						<div class="col-md-8">
							<input type="password" id="userInfo_password_header" name="userInfo.password"
								class="form-control" placeholder="请输入登录密码">
						</div>
					</div>
					<div class="form-group">
						...
						<div class="col-md-8">
							<select id="userInfo_areaObj_areaId_header"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" id="userInfo_name_header" name="userInfo.name"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" id="userInfo_sex_header" name="userInfo.sex"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<img class="img-responsive" id="userInfo_userPhotoImg_header"
								border="0px" /><br /> <input type="hidden"
								id="userInfo_userPhoto_header" name="userInfo.userPhoto" /> 
								
								<input id="userPhotoFile_header_header" name="userPhotoFile" type="file" size="50" />
						</div>
					</div>
					<div class="form-group">
						<label for="userInfo_birthdayDiv_header" class="col-md-3 text-right">出生日期:</label>
						<div class="col-md-8">
							<div id="userInfo_birthdayDiv_header"
								class="input-group date userInfo_birthday col-md-12"
								data-link-field="userInfo_birthday"
								data-link-format="yyyy-mm-dd">
								<input class="form-control" id="userInfo_birthday_header"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" id="userInfo_telephone_header"
					...
					<div class="form-group">
						...
						<div class="col-md-8">
							<input type="text" id="userInfo_address_header" name="userInfo.address"
	...
	$("#userPhotoFile_header").change(function(){
        ...
        if (window.FileReader)
        {
            ...
            reader.onloadend = function (e) {
                $("#userInfo_userPhotoImg_header").attr("src",e.target.result);
            };
        }
	});
});
	...
	$(function() {
		...
		$.ajax({
			...
			success : function(areas, response, status) {
				$("#userInfo_areaObj_areaId_header").empty();
				var html = "";
				$(areas).each(
						function(i, area) {
				...
				$("#userInfo_areaObj_areaId_header").html(html);
			}
		});
		//出生日期组件
		$('#userInfo_birthdayDiv_header').datetimepicker({
			language:  'zh-CN',  //显示语言
			format: 'yyyy-mm-dd',
			minView: 2,
			weekStart: 1,
