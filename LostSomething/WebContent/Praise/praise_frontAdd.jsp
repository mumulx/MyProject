...
<div class="container">
	...
	<!-- 					  <div class="form-group">
						  ...
						  <div class="form-group">
						  	 <label for="praise_lostFoundObj_lostFoundId" class="col-md-2 text-right">失物招领Id:</label>
						  	 <div class="col-md-8">
							    <select id="praise_lostFoundObj_lostFoundId" name="praise.lostFoundObj.lostFoundId" class="form-control">
							    </select>
						  	 </div>
						  ...
						  <div class="form-group">
						  	 <label for="praise_lostFoundObj_title" class="col-md-2 text-right">招领信息:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="praise_lostFoundObj_title" name="praise.lostFoundObj.title" class="form-control" readonly>
							 </div>
						  </div>
						  <div class="form-group">
...
$(document).ready(function(){
	...
	$("#praise_lostFoundObj_lostFoundId").change(function(){
		var title=$(this).find("option:selected").attr("lostfound_title")
		$("#praise_lostFoundObj_title").val(title);
	});
});
...
$(function(){
	...
	$.ajax({
		...
		success: function(lostFounds,response,status) { 
    		...
    		$("#praise_lostFoundObj_title").val(lostFounds[0].title);
    	}
	});
	//表扬时间组件
