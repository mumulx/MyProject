		       ...
		       text: "学院管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Area/area_add.jsp"
			    	   	},
			    		{
			    	   		text: "学院管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Area/area_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "寻物启事管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "LookingFor/lookingFor_add.jsp"
			    	   	},
			    		{
			    	   		text: "寻物启事管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "LookingFor/lookingFor_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "失物招领管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "LostFound/lostFound_add.jsp"
			    	   	},
			    		{
			    	   		text: "失物招领管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "LostFound/lostFound_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "认领管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Claim/claim_add.jsp"
			    	   	},
			    		{
			    	   		text: "认领管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Claim/claim_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "表扬管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Praise/praise_add.jsp"
			    	   	},
			    		{
			    	   		text: "表扬管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Praise/praise_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "站内通知管理",
